    ...
    subsections: [
      ...
      },
      {
        ...
        questions: [
          ...
          {
            id: "q4b",
            q: "Has your income been stable over the last three years?",
            type: "combo",
            options: ["Yes", "No"],
    ...
    subsections: [
      {
        ...
        questions: [
          ...
          {
            id: "cps13",
            q: "Do you require specific use cases, like integrating with traditional portfolios or using crypto for payments?",
            type: "text",
          },
          {
            id: "cps14",
